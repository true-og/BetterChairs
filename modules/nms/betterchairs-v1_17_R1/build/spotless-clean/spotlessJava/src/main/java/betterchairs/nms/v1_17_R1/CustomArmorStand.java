...
class CustomArmorStand extends EntityArmorStand implements CustomChairEntity {
    ...
    public void tick() {
        ...
        Entity passenger =
                this.getPassengers().isEmpty() ? null : this.getPassengers().get(0);
        ...
        if (ChairUtils.didChairEntityMove(this.expectedLocation, this.locX(), this.locY(), this.locZ())) {
            ...
            this.teleportAndSync(
                    this.expectedLocation.getX(), this.expectedLocation.getY(), this.expectedLocation.getZ());
        }
    ...
    private boolean shouldDie() {
        return this.remove
                ...
                || !(this.getPassengers().get(0) instanceof EntityHuman);
    }
}
