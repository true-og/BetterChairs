package betterchairs.nms.v1_11_R1;
...
public class v1_11_R1 extends ChairNMS {
    @Override
    @NotNull
    public org.bukkit.entity.Entity spawnChairEntity(
    ...
    public void killChairEntity(@NotNull org.bukkit.entity.Entity entity) {
        ...
        if (!(nmsEntity instanceof CustomChairEntity)) {
            throw new IllegalArgumentException(
                    String.format(Messages.ERR_NOT_CUSTOM_ENTITY, CustomChairEntity.class.getName()));
        }
    ...
    public boolean isSlab(@NotNull Block block) {
        return (block.getState().getData() instanceof Step || block.getState().getData() instanceof WoodenStep)
