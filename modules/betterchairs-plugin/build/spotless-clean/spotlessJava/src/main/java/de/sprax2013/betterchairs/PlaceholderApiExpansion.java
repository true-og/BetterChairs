...
public class PlaceholderApiExpansion extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, @NotNull String placeholder) {
        if (placeholder.equalsIgnoreCase("chairs_enabled")) {
            ...
            return Boolean.valueOf(!ChairManager.getInstance().hasChairsDisabled(player))
                    .toString();
        }
        ...
        if (placeholder.equalsIgnoreCase("sitting")) {
            ...
            return Boolean.valueOf(ChairManager.getInstance().getChair(player.getPlayer()) != null)
                    .toString();
        }
