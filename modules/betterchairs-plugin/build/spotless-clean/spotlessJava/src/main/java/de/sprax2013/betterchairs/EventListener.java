...
public class EventListener implements Listener {
    ...
    private void onInteract(PlayerInteractEvent e) {
        ...
        if (Settings.NEEDS_SIGNS.getValueAsBoolean()) {
            ...
            BlockFace side1 =
                    (rotation == BlockFace.NORTH || rotation == BlockFace.SOUTH) ? BlockFace.WEST : BlockFace.NORTH;
            BlockFace side2 =
                    (rotation == BlockFace.NORTH || rotation == BlockFace.SOUTH) ? BlockFace.EAST : BlockFace.SOUTH;
            ...
            boolean signOption1 = side1
                            != getManager().chairNMS.getBlockRotation(block1).getOppositeFace()
                    || side2 != getManager().chairNMS.getBlockRotation(block2).getOppositeFace();
            boolean signOption2 = side2
                            != getManager().chairNMS.getBlockRotation(block1).getOppositeFace()
