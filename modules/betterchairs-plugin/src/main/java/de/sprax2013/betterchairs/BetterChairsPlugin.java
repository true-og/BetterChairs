...
public class BetterChairsPlugin extends JavaPlugin {
    ...
    private ChairNMS getNewNMSInstance() {
        ...
        try {
            assert version != null;
            return (ChairNMS) Class.forName("betterchairs.nms." + version + "." + version)
                    .getConstructors()[0]
                    .newInstance();
            ...
            if (throwable instanceof Error) {
                getLogger()
                        .log(
                                Level.SEVERE,
                                "A critical error occurred while trying to load NMS support for version "
            ...
            getLogger()
                    .warning("Your server version (" + (version != null ? version : "UNKNOWN")
            ...
            return new ChairNMS() {
                ...
                @Override
                @NotNull
                public Entity spawnChairEntity(
                ...
                public boolean isChair(@NotNull Entity entity) {
                    ...
                    // Other plugins preventing our ArmorStand from spawning can thus not be prevented from such
                    // behavior
